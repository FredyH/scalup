...
sealed trait LuaAST extends LuaAST
...
sealed trait FunctionCall extends PrefixExpression {
...
case class ForLoop(variableName: String, initialValue: Expression, stepValue: Option[Expression], upperBound: Expression, block: Block) extends Statement
...
case class LuaString(value: String, multiline: Boolean) extends Expression
